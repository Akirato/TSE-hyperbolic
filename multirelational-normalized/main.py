...
class Experiment:
    ...
    def __init__(self, learning_rate=50, dim=40, nneg=50, model="taylor",
    ...
    def train_and_eval(self):
        ...
        if self.model == "taylor":
            model = MuRT(d, self.dim,self.c)
        else:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, default="taylor", nargs="?",
                    help="Which model to use: taylor or poincare or euclidean.")
