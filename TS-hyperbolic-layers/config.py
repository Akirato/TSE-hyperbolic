...
config_args = {
    ...
    'model_config': {
        ...
        'curvature-patience': (None, 'patience for increasing the curvature'),
        'c-coeff': (0.02, 'delta to increase the curvature'),
    ...
    'data_config': {
        ...
        'scale': (1.0, 'coefficient that scales the input (feature-value / scale.'),
